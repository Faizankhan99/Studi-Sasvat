...
// CouponController
router.post('/coupon', middleWare, CouponController.store)
router.post('/coupon-valid', middleWare, CouponController.fetchAllValid)
router.post('/validate-coupon', middleWare, CouponController.validateCoupon)
router.get('/coupon', CouponController.fetchAll)
router.get('/coupon/:id', CouponController.fetchSingle)
router.put('/coupon/:id', middleWare, CouponController.update)
router.delete('/coupon/:id', middleWare, CouponController.delete)
