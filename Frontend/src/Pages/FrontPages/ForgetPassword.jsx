            ...
            <div className="container mt-5">
                ...
                <div className='row mt-4'>
                    ...
                    <div className="col-md-6 mb-3">
                        <div className='border border-secondary-subtle px-3 py-4 mb-3'>
                            {
                                section == 'fp' &&
                                <>
                                    ...
                                    <form onSubmit={handleFpSubmit}>
                                        <TextField 
                                            ...
                                            required
                                        />
                                        <div className='fw-bold text-red' style={{ fontSize: '12px' }}><small><i className="fa-solid fa-circle-exclamation"></i> Registered mobile/whatsapp number on Studio Sasvat.</small></div>
                                        <Button type='submit' variant="contained" size='small' className='w-100 mt-3 bg-button-primary'>Send OTP&nbsp;&nbsp;<SendIcon fontSize='small' /></Button>
                                    </form>
                                </>
                            }
                            {
                                ...
                                <>
                                    ...
                                    <form onSubmit={handleVtSubmit}>
                                        <TextField 
                                            ...
                                            required
                                        />
                                        <Button type='submit' variant="contained" size='small' className='w-100 mt-3 bg-button-primary'>Verify OTP&nbsp;&nbsp;<VerifiedIcon fontSize='small' /></Button>
                                    </form>
                                </>
                            }
                            {
                                ...
                                <>
                                    ...
                                    <form onSubmit={handleRpSubmit}>
                                        ...
                                        <TextField 
                                            ...
                                            required
                                        />
                                        <Button type='submit' variant="contained" size='small' className='w-100 mt-3 bg-button-primary'>Reset Password&nbsp;&nbsp;<LockIcon fontSize='small' /></Button>
                                    </form>
                                </>
                            }
                        </div>
