                ...
                <div className='row mt-5'>
                    <div className="col-md-12">
                        ...
                        <div className='text-center'>
                            Welcome to Studio Sasvat. By accessing and using this website, you can use it as a Mobile Application also:
                        </div>
                        <div className='text-primary fw-bold mt-3'>Steps to Install Mobile Application:</div>
                        <ul>
                            <li>
                                <span>Step 1: Open <a href="https://studiosasvat.com/" target='_blank' className='text-primary'>studiosasvat.com</a> in Google Chrome (in your Mobile/Tablet).</span>
                            </li>
                            <li>
