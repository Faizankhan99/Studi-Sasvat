                ...
                <div className='row mt-3'>
                    <div className="col-md-12">
                        ...
                        <ul>
                            ...
                            <li><span className='fw-bold'>And More:</span> Beyond jewelry and furniture, we also offer a variety of other artistic creations, including home décor items, accessories, and custom pieces. Every product at Studio Sasvat is crafted with the same commitment to quality and originality.</li>
                        </ul>
                        ...
                        <ul>
                            <li><span className='fw-bold'>Unique Designs:</span> Our products are handcrafted and designed to be truly unique. When you buy from Studio Sasvat, you're not just buying a product; you're investing in a piece of art.</li>
                        ...
                        <div>We invite you to explore our collections and discover the perfect pieces that resonate with your style and personality. At Studio Sasvat, we believe that every piece has a story to tell – and we can't wait to be a part of yours.</div>
                        <br />
                        <div>Thank you for choosing Studio Sasvat. We look forward to being a part of your artistic journey.</div>
                    </div>
                </div>
            </div>
