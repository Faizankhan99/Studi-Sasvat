...
import { getCategoryProduct, getProducts, resetProductState } from '../../Features/Product/ProductSlice';
...
const SelectedCategoryProducts = () => {
    ...
    useEffect(()=>{
        if(responseStatus == 'success' && responseMessage == 'Get All Category Wise'){
    ...
    useEffect(()=>{
        if(subCategoryResponseStatus == 'success' && subCategoryResponseMessage == 'Get All'){
            setCategoryList(subCategories?.data)
            setTimeout(() => {
                setFullPageLoading(false)
            }, 1000);
        }
                    ...
                    subCategoryList?.length > 0 ?
                        <div className="row">
                            <div className='mb-3 d-flex flex-wrap align-items-center justify-content-between gap-3'>
                                <h3 className='text-primary'><img src="/logoFinal2.png" style={{ height: '25px' }} alt="/logoFinal2.png" /> Shop by Sub Category</h3>
                            ...
                            <SubCategorySwiper data={subCategoryList && subCategoryList?.length > 0 ? subCategoryList : []} />
                        </div>
                    : ''
                }
                <div className='row my-5'>
                    <div className='mb-3 d-flex flex-wrap align-items-center justify-content-between gap-3'>
                        <h3 className='text-primary'><img src="/logoFinal2.png" style={{ height: '25px' }} alt="/logoFinal2.png" /> {list[0]?.categoryName || 'No Product Found'}</h3>
