            ...
            <div className="container mt-5">
                ...
                <div className='row mt-4'>
                    ...
                    <div className="col-md-12">
                        <small><i className="fa-regular fa-circle-question"></i> Welcome to the Studio Sasvat Help Center. Please feel free to send us your Query. We will soon resolve it.</small>
                        <ButtonBase className='w-100 text-start border-bottom border-secondary-subtle p-2 mt-3'>
                            <div className='w-100'>Send us mail @ studiosasvat@gmail.com</div>
                        </ButtonBase>
                        <div className='w-100 text-start border-bottom border-secondary-subtle p-2'>
                            <div className='w-100'>
                                <div className='mb-3'>Send us via Studio Sasvat Message Box!</div>
                                <div className="row">
