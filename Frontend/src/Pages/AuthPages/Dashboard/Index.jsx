            ...
            <div className="container mt-5" style={{ minHeight: '50vh' }}>
                <div className="row pt-5">
                    <div className="col-md-3">
                        <Button type='button' className='mb-2 w-100 py-3 border-primary text-primary' variant="outlined" onClick={()=>navigate('/studio-sasvat/products')}>
                            <CategoryIcon />&nbsp;&nbsp;<span>Products</span>
                        </Button>
                    </div>
                    <div className="col-md-3">
                        <Button type='button' className='mb-2 w-100 py-3 border-primary text-primary' variant="outlined" onClick={()=>navigate('/studio-sasvat/orders')}>
