                            ...
                            <div className="row">
                                ...
                                <div className="col-md-9 mb-4">
                                    ...
                                    <div>Qty: {data?.quantitySelected}</div>
                                    {
                                        ...
                                        <>
                                            <h4 className='fw-bold text-secondary mt-3'>Coupon Applied</h4>
                                            <div><span className='text-secondary fw-bold'>Coupon Code:</span> <Link to={`/studio-sasvat/coupon-edit/${data?.couponId}`} className='text-primary text-decoration-none fw-bold'>{data?.couponName}</Link></div>
                                            <div><span className='text-secondary fw-bold'>Coupon Offer:</span> {data?.couponBasedOn == 'Discount' ? `Received ${data?.couponPercentage}% OFF on this Product` : `Received ₹${data?.couponPrice} OFF on this Product`}</div>
                                        </>
                                        : ''
                                    }
                                </div>
