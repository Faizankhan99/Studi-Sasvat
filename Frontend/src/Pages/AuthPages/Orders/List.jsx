                                            ...
                                            Array?.isArray(list) && list?.map((val,key)=>(
                                                <tr key={key} className={viewType != 'All' ? val?.status == viewType ? '' : 'd-none' : ''}>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Link to={`/studio-sasvat/order-detail/${val?.orderUniqueId}`} className='text-decoration-none text-primary fw-bold'>
                                                            <Avatar
                                                    ...
                                                    <td className='p-2 text-nowrap fw-bold text-primary' role='button' onClick={()=>navigate(`/studio-sasvat/order-detail/${val?.orderUniqueId}`)}>{val?.billingAddressName}</td>
                                                    <td className='p-2 text-nowrap fw-bold text-primary' role='button' onClick={()=>navigate(`/studio-sasvat/order-detail/${val?.orderUniqueId}`)}>{val?.billingAddressContactNumber}</td>
                                                    <td className='p-2 text-nowrap'><Link to={`/studio-sasvat/order-detail/${val?.orderUniqueId}`} className='text-decoration-none text-primary fw-bold'>{val?.productName}</Link></td>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Tooltip title="Detail" onClick={()=>setTimeout(() => {
                                                            navigate(`/studio-sasvat/order-detail/${val?.orderUniqueId}`)
                                                        }, 500)}>
                                                            <IconButton>
