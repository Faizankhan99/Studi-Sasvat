                    ...
                    <div className="col-md-12">
                        <div className='d-flex align-items-center justify-content-between mb-3'>
                            ...
                            <Button type='button' variant="outlined" className='px-4 border-primary text-primary' size='small' onClick={()=>setTimeout(() => {
                                navigate('/studio-sasvat/product-add')
                        ...
                        <div className='bg-white p-3 custom-box-shadow'>
                            ...
                            />
                            <div className='mb-3 fw-bold'><span className='bg-button-primary text-white rounded py-1 px-4'>Total Records: {products?.totalRecords}</span></div>
                                            ...
                                            Array?.isArray(list) && list?.map((val,key)=>(
                                                <tr key={key}>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Link to={`/studio-sasvat/product-edit/${val?._id}`} className='text-decoration-none text-primary fw-bold'>
                                                            <Avatar
                                                    ...
                                                    <td className='p-2 text-nowrap'><Link to={`/studio-sasvat/product-edit/${val?._id}`} className='text-decoration-none text-primary fw-bold'>{val?.productName}</Link></td>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Tooltip title="Edit" onClick={()=>setTimeout(() => {
                                                            navigate(`/studio-sasvat/product-edit/${val?._id}`)
                                                        }, 500)}>
                                                            <IconButton>
