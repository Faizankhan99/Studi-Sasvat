...
const ProductForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        formdata.append('cashOnDelivery', data?.cashOnDelivery)
        ...
        if(responseStatus == 'success' && responseMessage == 'Get Single'){
            ...
            setTimeout(() => {
                setData({
                    ...
                    shippingCharge: products?.data?.shippingCharge,
                    ...
                    cashOnDelivery: products?.data?.cashOnDelivery,
                })
            }, 1000);
            setTimeout(() => {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                />
                                <small className='text-red'>Max word limit 1000.</small>
                            </div>
                            <div className="col-md-6">
                                ...
                                />
                                <small className='text-red'>Max word limit 2000.</small>
                            </div>
                            ...
                            <div className="col-md-12">
                                <div className='d-flex align-items-center gap-5'>
                                    ...
                                    <div className='d-flex align-items-center gap-1'>
                                        <Checkbox 
                                            name='cashOnDelivery' 
                                            checked={ data?.cashOnDelivery == 1 ? true : false}
                                            onChange={(e)=>setData({
                                                ...data,
                                                cashOnDelivery: e.target.checked ? 1 : 0
                                            })} 
