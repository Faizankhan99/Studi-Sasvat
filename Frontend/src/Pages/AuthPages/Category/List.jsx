                    ...
                    <div className="col-md-12">
                        <div className='d-flex align-items-center justify-content-between mb-3'>
                            ...
                            <Button type='button' variant="outlined" className='px-4 border-primary text-primary' size='small' onClick={()=>setTimeout(() => {
                                navigate('/studio-sasvat/category-add')
                                                ...
                                                <tr key={key}>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Tooltip title="Edit" onClick={()=>setTimeout(() => {
                                                            navigate(`/studio-sasvat/category-edit/${val?._id}`)
                                                        }, 500)}>
                                                            <IconButton>
                    ...
                    <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                        ...
                        <div className='d-flex align-items-center gap-3'>
                            ...
                            <Button type='button' variant='contained' size='small' className='bg-button-primary px-4' onClick={()=>{
                                navigate(selectedOption == 1 ? `/studio-sasvat/sub-categories-by-category/${selectedCategoryId}` : selectedOption == 2 ? `/studio-sasvat/category-edit/${selectedCategoryId}` : alert('Please select any option'))
                            }}>Done</Button>
                        </div>
                    </Typography>
                </Box>
