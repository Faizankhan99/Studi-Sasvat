                    ...
                    <div className="col-md-12">
                        <div className='d-flex align-items-center justify-content-between mb-3'>
                            ...
                            <Button type='button' variant="outlined" className='px-4 border-primary text-primary' size='small' onClick={()=>setTimeout(() => {
                                navigate('/studio-sasvat/sub-category-add')
                                            ...
                                            Array?.isArray(currentItems) && currentItems?.map((val,key)=>(
                                                <tr key={key}>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Link to={`/studio-sasvat/sub-category-edit/${val?._id}`} className='text-decoration-none text-primary fw-bold'>
                                                            <Avatar
                                                    ...
                                                    <td className='p-2 text-nowrap'><Link to={`/studio-sasvat/sub-category-edit/${val?._id}`} className='text-decoration-none text-primary fw-bold'>{val?.subCategoryName}</Link></td>
                                                    <td className='p-2 text-nowrap'><Link to={`/studio-sasvat/category-edit/${val?.categoryId}`} className='text-decoration-none text-primary fw-bold'>{val?.categoryName}</Link></td>
                                                    ...
                                                    <td className='p-2 text-nowrap'>
                                                        <Tooltip title="Edit" onClick={()=>setTimeout(() => {
                                                            navigate(`/studio-sasvat/sub-category-edit/${val?._id}`)
                                                        }, 500)}>
                                                            <IconButton>
