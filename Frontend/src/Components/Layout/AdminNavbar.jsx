                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/users">
                                    <Tooltip title="Users">
                                        <IconButton>
                                            {/* <CategoryIcon /> */}
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/categories">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/sub-categories">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/coupons">
                                    <Tooltip title="Coupons">
                                        <IconButton>
                                            {/* <CategoryIcon /> */}
                                            <small className='text-primary fw-bold' style={{ fontSize: '16px' }}>Coupons</small>
                                        </IconButton>
                                    </Tooltip>
                                </Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/main-banner">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/studio-sasvat/secondary-banner">
