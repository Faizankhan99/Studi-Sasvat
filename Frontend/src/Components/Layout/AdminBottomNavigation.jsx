...
const AdminBottomNavigation = () => {
    ...
    useEffect(()=>{
        if(location.pathname === '/studio-sasvat/dashboard'){
            setPage('dashboard')
        }
        if(location.pathname === '/studio-sasvat/products'){
            setPage('products')
        }
    ...
    return (
        <>
            ...
            <div className='w-100 fixed-bottom bg-white border-top border-secondary-subtle bottom-nav d-flex align-items-center justify-content-between gap-3 px-2' style={{ zIndex: '99999999' }}>
                ...
                <small>
                    <Link className="nav-link" aria-current="page" to="/studio-sasvat/dashboard">
                ...
                <small>
                    <Link className="nav-link" aria-current="page" to="/studio-sasvat/products">
                ...
                <small>
                    <Link className="nav-link" aria-current="page" to="/studio-sasvat/orders">
            ...
            <div className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style={{ backgroundColor: '#000000d6', maxWidth: '90% !important', paddingBottom: '150px' }}>
                ...
                <div className="offcanvas-body text-white">
                    ...
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        setTimeout(() => {
                            navigate('/studio-sasvat/main-banner')
                        }, 500)
                    }}>
                    ...
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        setTimeout(() => {
                            navigate('/studio-sasvat/secondary-banner')
                        }, 500)
                    }}>
                    ...
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        setTimeout(() => {
                            navigate('/studio-sasvat/categories')
                        }, 500)
                    }}>
                    ...
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        setTimeout(() => {
                            navigate('/studio-sasvat/sub-categories')
                        }, 500)
                    }}>
                    ...
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        ...
                        <i className="fa-solid fa-ticket" style={{ width: '50px', fontSize: '20px' }}></i>
                        <span className=''>Coupons</span>
                    </div>
                 
                    <div className='d-flex align-items-center mb-3 px-2 py-1 rounded nav-mobile-menus' data-bs-dismiss="offcanvas" aria-label="Close" onClick={()=>{
                        setTimeout(() => {
                            navigate('/studio-sasvat/orders')
                        }, 500)
                    }}>
