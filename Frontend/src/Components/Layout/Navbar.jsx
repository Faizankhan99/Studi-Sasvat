...
const Navbar = ({ renderNavCart, setRenderNavCart, renderNavWishlist, setRenderNavWishlist }) => {
    ...
    const handleLogout = () => {
        Cookies.remove('studioSasvatLoggedInUserToken')
        Cookies.remove('studioSasvatLoggedInUser')
        ...
        <>
                        ...
                        <div>
                            <div className="marquee d-flex gap-5 bg-dark pb-1">
                                <div className="marquee-content">
                                    <div className="text-white">Welcome to Studio Sasvat – Where creativity meets craftsmanship, and every piece tells a story! Dive into a world of artistic excellence with our expansive collection of art, decor, and handcrafted treasures. Our carefully curated pieces are designed to inspire and elevate your living spaces, offering a perfect blend of tradition, style, and modern flair!</div>
                    ...
                    <div>
                        <Link className='text-decoration-none' to="/">
                            <div className='d-flex align-items-center gap-1'>
                                ...
                                <span className='text-primary fw-bold fst-italic nav-main-logo' style={{ fontFamily: 'Cedarville Cursive' }}>Studio Sasvat</span>
                            </div>
                        </Link>
                    </div>
                                ...
                                <Tooltip title="Wishlist">
                                    <IconButton aria-label="wishlist">
                                        <StyledBadge badgeContent={wishlistData?.length} color="primary">
                                            <FavoriteIcon className={page == 'wishlist' ? 'text-primary' : ''} sx={{ color: 'red' }} />
                                        </StyledBadge>
                                    </IconButton>
                                </Tooltip>
                            </Link>
                                ...
                                <Tooltip title="Cart">
                                    <IconButton aria-label="cart">
                                        <StyledBadge badgeContent={cartData?.length} color="primary">
                                            <ShoppingCartIcon className={page == 'cart' ? 'text-primary' : ''} sx={{ color: 'grey' }} />
                                        </StyledBadge>
                                    </IconButton>
                                </Tooltip>
                            </Link>
                            {
                                !isLoggedIn ?
                                    <Link className="nav-link" aria-current="page" to="/login">
                                        <Tooltip title="Login">
                                            <IconButton>
                                                <AccountCircleIcon className={page == 'login' ? 'text-primary' : ''} sx={{ color: '#22696b' }} />
                                            </IconButton>
                                        </Tooltip>
                                    </Link>
                                :
                                    ...
                                    <Link className="nav-link" aria-current="page" to="/my-profile">
                                        <Tooltip title="Profile">
                                            <IconButton aria-label="profile">
                                                <AccountCircleIcon className={page == 'my-orders' ? 'text-primary' : ''} sx={{ color: '#22696b' }} />
                                            </IconButton>
                                        </Tooltip>
                                    </Link>
                                </>
                            ...
                            </span>
                            {
                                !isLoggedIn ?
                                    <Link className="nav-link" aria-current="page" to="/login">
                                        <Tooltip title="Login">
                                            <IconButton>
                                                <AccountCircleIcon fontSize='small' className={page == 'login' ? 'text-primary' : ''} sx={{ color: '#22696b' }} />
                                            </IconButton>
                                        </Tooltip>
                                    </Link>
                                :
                                <>
                                    <Link className="nav-link" aria-current="page" to="/my-profile">
                                        <Tooltip title="Profile">
                                            <IconButton aria-label="profile">
                                                <AccountCircleIcon fontSize='small' className={page == 'my-orders' ? 'text-primary' : ''} sx={{ color: '#22696b' }} />
                                            </IconButton>
                                        </Tooltip>
                                    </Link>
                                </>
            ...
            <div className="offcanvas offcanvas-top" tabIndex="-1" id="searchBarCanvas" aria-labelledby="searchBarCanvasLabel" style={{ backgroundColor: '#000000d6' }}>
                <div className="offcanvas-header">
                    <h5 className="offcanvas-title text-white" id="searchBarCanvasLabel"><img src="/logoFinal2.png" style={{ height: '30px' }} alt="/logoFinal2.png" /> <span className='fw-bold fst-italic' style={{ fontFamily: 'Cedarville Cursive' }}>Studio Sasvat</span></h5>
            ...
            <div className="offcanvas offcanvas-start" tabIndex="-1" id="sideMenuDrawer" aria-labelledby="sideMenuDrawerLabel" style={{ backgroundColor: '#000000d6', maxWidth: '90% !important', paddingBottom: '150px' }}>
                <div className="offcanvas-header">
                    <h5 className="offcanvas-title text-white" id="sideMenuDrawerLabel"><img src="/logoFinal2.png" style={{ height: '30px' }} alt="/logoFinal2.png" /> <span className='fw-bold fst-italic' style={{ fontFamily: 'Cedarville Cursive' }}>Studio Sasvat</span></h5>
                    <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"><i className="fa-solid fa-xmark" style={{ color: '#fff' }}></i></button>
                </div>
