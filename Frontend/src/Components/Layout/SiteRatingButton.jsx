    ...
    return (
        <>
            ...
            <div className='site-rating-button'>
                <center>
                    <Button type='button' variant='contained' size='small' className='bg-dark text-white rounded-0' sx={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }} onClick={fetchRatings}><i className="fa-solid fa-star"></i>&nbsp;&nbsp;Reviews</Button>
                </center>
            </div>
