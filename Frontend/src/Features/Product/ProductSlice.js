...
export const getProducts = createAsyncThunk(
    ...
    async () => {
        try {
            ...
            const isExistRelatedProducts = localStorage.getItem('/related-products')
            const isExistFromAdmin = localStorage.getItem('/studio-sasvat/products')
            const isExistSearchedKeyword = localStorage.getItem('/studio-sasvat/productsSearchFilter')
            ...
            if (isExist) {
                ...
                if (isExistFromAdmin) {
                    ...
                    if (isExistRelatedProducts) {
                        var pageObj = JSON.parse(isExistRelatedProducts)
                        var pageNumber = pageObj?.page 
                    } else {
                        var pageNumber = 1
                    }
...
export const getBestSellingProducts = createAsyncThunk(
    ...
    async () => {
        try {
            ...
            const isExistRelatedProducts = localStorage.getItem('/related-products')
            const isExistFromAdmin = localStorage.getItem('/studio-sasvat/products')
            const isExistSearchedKeyword = localStorage.getItem('/studio-sasvat/ordersSearchFilter')
...
export const getCategoryProduct = createAsyncThunk(
    ...
    async (categoryId, { rejectWithValue }) => {
        try {
            const isExist = localStorage.getItem(`/category-product`)
...
export const getSubCategoryProduct = createAsyncThunk(
    ...
    async (subCategoryId, { rejectWithValue }) => {
        try {
            const isExist = localStorage.getItem(`/sub-category-product`)
